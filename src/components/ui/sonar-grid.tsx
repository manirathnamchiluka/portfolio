...
export function SonarGrid({
  ...
  React.useEffect(() => {
    ...
    // Listen during capture so clicks on content layered above the canvas still emit a ping.
    // This does not prevent the clicked element's normal event handling.
